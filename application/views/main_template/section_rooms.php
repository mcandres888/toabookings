...
<section class="rooms mt50">
  <div class="container">
    <div class="row">
      ...
      <!-- Room -->
      <div class="col-sm-4">
        <div class="room-thumb"> <img src="<?=base_url()?>main_data/images/rooms/356x228.gif" alt="room 1" class="img-responsive" />
          <div class="mask">
            <div class="main">
      ...
      <!-- Room -->
      <div class="col-sm-4">
        <div class="room-thumb"> <img src="<?=base_url()?>main_data/images/rooms/356x228.gif" alt="room 2" class="img-responsive" />
          <div class="mask">
            <div class="main">
      ...
      <!-- Room -->
      <div class="col-sm-4">
        <div class="room-thumb"> <img src="<?=base_url()?>main_data/images/rooms/356x228.gif" alt="room 3" class="img-responsive" />
          <div class="mask">
            <div class="main">
              <h5>Single room</h5>
